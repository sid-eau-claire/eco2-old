...
const EditRecord = ({selectedRecord, setSelectedRecord, isEditable, columnMode}: {selectedRecord: any, setSelectedRecord: any, isEditable?: boolean,  columnMode?: boolean}) => {
  ...
  useEffect(() => {
    const fetchNewCase = async () => {
      ...
      setValue('id', formData.id.toString());
      setValue('writingAgentId', formData.writingAgentId?.id.toString());
      setValue('caseType', formData.caseType);
      setValue('appInfo.carrierId', formData.appInfo.carrierId?.id.toString());
      formData.splitAgents.forEach((agent: any, index: number) => {
      ...
      setValue('appInfo.provinceId', formData.appInfo.provinceId?.id.toString());
      ...
      setValue('monthlyBillingPremium', formData.monthlyBillingPremium?.toString());
      setValue('status', formData.status);
      setValue('totalEstFieldRevenue', formData.totalEstFieldRevenue?.toString());
      ...
      setValue('estSettledDays', formData.estSettledDays?.toString());
  ...
  console.log('editRecord', formData)
  return (
    <>
