  ...
  const baseInput = (
    <div className={twMerge("mb-3.5")}>
      ...
      <input
        ...
        maxLength={maxLength}
        disabled={disabled}
        className={twMerge('w-full rounded border-[1.5px] border-stroke bg-transparent py-1 px-3 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary focus:bg-whiten', className)}
      />
