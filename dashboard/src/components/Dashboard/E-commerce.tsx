...
const ECommerce: React.FC = async () => {
  ...
  try {
    ...
    // const response = await fetch(`${process.env.STRAPI_BACKEND_URL}/api/articles?populate[0]=photo&filters[menu][$eq]=guidelines&filters[showInDashboard][$eq]=true&sort[0]=seq:asc&fields[0]=menu&fields[1]=subMenu&fields[2]=topic&fields[3]=summary`,
    ...
    guidelines = await response.json().then((data) => data.data);
