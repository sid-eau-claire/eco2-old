...
const DropdownMessage = () => {
  ...
  // const { isChatVisible, toggleChat, setChatTopic, setChatDepartment } = useChat();
  ...
  //     if (isChatVisible && event.key === "Escape") {
  //       toggleChat();
  //     }
  //   };
  ...
  // useEffect(() => {
  //   setChatTopic(pathname);
  //   setChatDepartment(pathname);
  // }, [pathname, setChatTopic, setChatDepartment]);

  return (
    <div className="relative">
      {/* <DropdownMenu open={isChatVisible} onOpenChange={toggleChat}>
        ...
        <DropdownMenuContent ref={dropdown} className="w-[380px]">
          <ChatComponent 
            user={"john"} 
